...
export default function ItemCard({ shop }: Shop) {
    ...
    return (
        <div className="relative flex w-full md:max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
                                    <a className="relative mt-3 flex h-60 overflow-hidden rounded-xl" href="#">
                                        <img className="object-cover bg-gray-100" src="https://www.alsem.nl/shop/5049-home_default/advocaat-klok-20cl-potflesje-18-0200-120005.jpg" alt="product image" />
                                    </a>
                                    <div className="mt-4 px-5 pb-5">
                                        ...
                                        <a onClick={() => onSaveState("test", "123", 1)} className="flex items-center justify-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
