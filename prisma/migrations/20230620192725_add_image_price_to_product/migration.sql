...
CREATE TABLE `Shops` (
    ...
    `description` VARCHAR(191) NOT NULL DEFAULT 'New shop',
...
-- AddForeignKey
ALTER TABLE `Shops` ADD CONSTRAINT `Shops_ownerId_fkey` FOREIGN KEY (`ownerId`) REFERENCES `User`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
